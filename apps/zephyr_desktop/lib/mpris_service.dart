...
/// Adapter that plugs the Linux MPRIS implementation into the shared
/// [MediaControlsService] seam consumed by zephyr_core.
class MprisMediaControls implements MediaControlsService {
  @override
  Future<void> init({
    required VoidCallback onPlayPause,
    required VoidCallback onNext,
